...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for the Nurses United 4 Children website',
      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div id="aria-font">
          ...
          <h1 className="text-[30px] text-[#333] pb-[10px] leading-[1em] font-[500]">
            Nurses United 4 Children Terms of Service
          </h1>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Welcome to Nurses United 4 Children! These Terms of Service (“Terms”) govern your access
            to and use of our website, services, and platforms (collectively, “Services”), provided
            by Nurses United 4 Children (“we,” “us,” or “our”). By accessing or using our Services,
          ...
          <ul className="list-inside ml-[1.5em] space-y-[4px]">
            ...
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              Using the Services to solicit funds outside the scope of Nurses United 4 Children’s
              mission.
            </li>
          </ul>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All donations made to Nurses United 4 Children are voluntary and non-refundable. By
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All payments made to Nurses United 4 Children are voluntary and non-refundable. No
            refunds will be given due to the nonprofit nature of Nurses United 4 Children.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            are the property of Nurses United 4 Children or its licensors. You agree not to use,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            controlled by Nurses United 4 Children. We are not responsible for the content, privacy
            policies, or practices of any third-party websites or services. You acknowledge and
            agree that Nurses United 4 Children shall not be liable for any damages or loss caused
            by or in connection with your use of any third-party websites or services.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Our Services are provided on an “as is” and “as available” basis. Nurses United 4
            Children makes no representations or warranties of any kind, express or implied,
            regarding the use or the results of our Services in terms of accuracy, reliability, or
            otherwise. Nurses United 4 Children disclaims all warranties, express or implied,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            To the fullest extent permitted by law, Nurses United 4 Children shall not be liable for
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            You agree to indemnify, defend, and hold harmless Nurses United 4 Children, its
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            States and the State of Florida, without regard to its conflict of law principles.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Thank you for supporting Nurses United 4 Children and for complying with these Terms of
            Service.
          </p>
        </div>
      </div>
